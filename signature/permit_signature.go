...
func NewFromJson(jsonTypedData string) (*Permit, error) {
...
func (p *Permit) SetOwnerFromString(val string) error {
...
func (p *Permit) SetSpenderFromString(val string) error {
...
func (p *Permit) SetValueFromString(val string) error {
...
func (p *Permit) SetNonceFromString(val string) error {
...
func (p *Permit) SetDeadlineFromString(val string) error {
...
func (p Permit) ToTypedData() apitypes.TypedData {
